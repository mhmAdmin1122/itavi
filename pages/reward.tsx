    ...
    <OpportunityLayout>
      <div>
        ...
        <ol className="flex items-start gap-4 flex-col pb-4 list-decimal pl-8">
          <li>
            <b className="text-[1.4rem] pb-2">Humanitarian Impact</b><br /> For every investment of at least $1000,
          ...
          <li>
            <b className="text-[1.4rem] pb-2">Precious Metals</b><br /> Depending on the investment level, investors
            will receive:
          ...
          <li>
            <b className="text-[1.4rem] pb-2">Exploration Adventure</b><br /> For investments of at least $250,000,
